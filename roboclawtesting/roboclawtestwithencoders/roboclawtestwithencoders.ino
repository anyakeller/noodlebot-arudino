...
// The quadrature encoder provides a resolution of 48 counts per 
//  revolution of the motor shaft when counting both edges of both channels. 
//  To compute the counts per revolution of the gearbox output, multiply 
//  the gear ratio by 48.


// for 4.4:1 pololu motor, 211.2 counts per revolution 
//  or 1056 counts per 5 revolutions.  
